...
import { mockReports, mockClients, mockUsers } from "@/lib/mock-data"
...
export default function MemberReportsPage() {
  ...
  useEffect(() => {
    ...
    setFilteredReports(mockReports.filter((r) => ids.includes(r.client_id)))
  }, [])

  const searched = filteredReports.filter(
    (r) =>
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">{filteredReports.length} relatório(s) dos meus clientes</p>
        </div>
      </div>
