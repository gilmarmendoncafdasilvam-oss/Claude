          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-4">
              ...
              <Button variant="ghost" size="sm" asChild>
                <Link href="/member/clients">Ver todos</Link>
              </Button>
            </CardHeader>
                      ...
                      >
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-medium text-gray-900 hover:text-blue-600 transition-colors">{client.company_name}</span>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-4 text-right" onClick={(e) => e.stopPropagation()}>
                          <Button variant="ghost" size="sm" asChild>
                            <Link href={`/member/clients/${client.id}`}>Ver</Link>
                          </Button>
                        </td>
                      </tr>
                    )
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-4">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href="/member/integrations">Configurar</Link>
            </Button>
          </CardHeader>
          <CardContent className="p-0">
